...
function gather(args) {
    ...
    newShape[axis] = tfjs_core_1.util.sizeFromShape(indices.shape);
    ...
    var xStridesBytes = new Uint8Array(new Int32Array(tfjs_core_1.util.computeStrides(x.shape)).buffer);
    var outStridesBytes = new Uint8Array(new Int32Array(tfjs_core_1.util.computeStrides(newShape)).buffer);
    wasmGather(xId, types_1.CppDType[x.dtype], xStridesBytes, stridesSize, indicesId, axis, outStridesBytes, outId);
    return out;
}
